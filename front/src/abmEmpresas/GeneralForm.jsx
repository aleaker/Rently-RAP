...
export default function GeneralForm({handleChange, values, handleBankDetails}){
    ...
    return(
        ...
        <Col xs={12}>
           ...
           onChange={evt=>handleChange({CompanyName:  evt.target.value})} value={values.CompanyName}
           ...
           <Row>
               <Col xs={6}>
           <input type="text" placeholder="Pais" id="business_Country" onChange={evt=>handleChange({Country:  evt.target.value})}
            disabled={values.disable}
           ...
           onChange={evt => handleChange({internationalCountryCode: evt.target.value})}
           disabled={values.disable}
           value={values.internationalCountryCode}/>
           </Col>
           <Col xs={2}>
           <input type="text" placeholder="Codigo de Area" id="business_Description"
           onChange={evt => handleChange({localCountryCode: evt.target.value})}
           disabled={values.disable}
           ...
           onChange={evt => handleBankDetails({SwiffCode: evt.target.value})}
           disabled={values.disable}
