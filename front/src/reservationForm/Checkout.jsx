...
const handleSubmit = e =>{
    e.preventDefault()
    props.fetchBooking({customer: state,  reservation: reservation, user: props.user }).then(result => {
  ...
  return (
    <Box >
      <Typography style={{ padding: "1%"}} variant="h4" component="h2" align="left">
            Reserva
          </Typography>
    
    <div className={classes.container}>
      <Card >
      <Typography style={{ padding: "1%"}} variant="h6" component="h6" align="center">
            Datos del Conductor
          </Typography>
      ...
      />
        ...
        />
        <CardContent>
          <div style={{backgroundColor: "#e6e6e6", margin: "1%", padding: "1%", color: "#808080"}}>
